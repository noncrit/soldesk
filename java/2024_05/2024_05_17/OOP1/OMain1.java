...
//알고리즘의 시대는 조금씩 저물고있다-점점 유지보수가 중요해지는 시대가 오기 시작함
//기존 프로그래밍 방식 
...
//즉, 객체를 모아서 하나의 완성품을 만들어내는 프로그래밍 기법이 객체 지향
...
public class OMain1 {
	...
	public static void main(String[] args) {
		...
		Cafe c = new Cafe();	//Cafe 참조변수 c에 Cafe 클래스의 틀을 가져옴
