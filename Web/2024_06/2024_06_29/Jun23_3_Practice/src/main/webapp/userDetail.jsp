...
<body>
	...
	<table border=1>
	<form name="userUpdateForm" method="post"  action="UserDetailController" enctype="multipart/form-data">
		<tr>
			<td>ID : </td>
		...
		<tr>
			<td>Pw : </td>
			<td class="td2"><input  name="j_PW" class="inputt"value="${user.j_PW}"></td>
		</tr>
